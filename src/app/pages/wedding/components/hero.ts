    ...
    <animated-container [className]="isWide() ? 'overflow-hidden' : 'pt-6'">
      ...
      >
        <img
          ...
          src="/pages/travel/gloria/gloria3.jpg"
          alt="Wedding Halls Hero Background"
        />
        <div
      ...
      <div class="container">
        ...
        >
          <div class="absolute inset-0 overflow-y-clip">
            ...
            >
              <div
                class="title bg-[linear-gradient(120deg,#FFF_-16.99%,rgba(255,255,255,0.00)_100%)] text-8xl lg:text-[17rem] leading-none lg:-mt-14"
              >
                wedding halls
              </div>
            </div>
